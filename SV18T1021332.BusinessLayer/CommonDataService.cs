...
namespace SV18T1021332.BusinessLayer
{/// <summary>
 ...
 /// </summary>
    public static class CommonDataService
    {
        ...
        {
            return countryDB.List(1, 0, "").ToList();
        }
        /// <summary>
        /// Danh sách quốc gia (Tìm kiếm, Phân trang)
        /// </summary>
        ...
        /// <returns></returns>
        public static List<Country> ListOfCountries(int page,
                                                       int pageSize,
                                                       string searchValue,
                                                       out int rowCount)
        {
        ...
        /// <summary>
        /// Danh sách Loại hàng (Sắp xếp, phân trang)
        /// </summary>
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        /// <param name="searchValue"></param>
        ...
        /// <summary>
        /// Kiểm tra mặt hàng có thông tin liên quan
        /// </summary>
        /// <param name="shipperID"></param>
        /// <returns></returns>
